...
export function MobileNav() {
  ...
  return (
    <div className="lg:hidden">
      ...
      {/* Overlay wordt naar document.body geportaald: de header heeft
          backdrop-blur, wat een containing block vormt en een fixed-overlay
          anders binnen de 80px-hoge balk opsluit. */}
      {open
        ? createPortal(
            <div className="fixed inset-0 z-50 flex flex-col bg-cream-100 lg:hidden">
              ...
              <nav
                ...
                className="flex flex-1 flex-col overflow-y-auto px-6 pb-8 pt-2"
              >
