...
export async function updateProperty(
  ...
  const payload = {
    ...
    tagline_nl: trimOrNull(formData.get("tagline_nl")),
    short_description: trimOrNull(formData.get("short_description")),
    short_description_nl: trimOrNull(formData.get("short_description_nl")),
    description: trimOrNull(formData.get("description")),
    description_nl: trimOrNull(formData.get("description_nl")),
